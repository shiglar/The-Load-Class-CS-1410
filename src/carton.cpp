...
/**
 * @brief - New Carton constructor
 *  Calls ShippingItem to pass in address, weight, side1;
 *  Throw exception if sides are less than kMinSize
 *  Set measurements from side parameters
 * @param address - Address object
 * @param weight - double type
 * @param side1 - double type
 * @param side2 - double type
 * @param side3 - double type
 */
...
/**
 * @brief - Display Carton information
